...
sources = [{:name => "Daily Trust", :home_page => "www.dailytrust.com.ng", :feed_type => 'RSS', :url => "http://www.dailytrust.com.ng/index.php/rss/xml/RSS2.0/full", :quality_rating => "10"},
           #{:name => "CLEEN Foundation", :home_page => "http://www.kabissa.org/directory/CLEEN", :feed_type => 'RSS', :url => "http://feeds.feedburner.com/CleenFoundation?format=xml", :quality_rating => 10},
